REM Remove previously compiled code
...
REM Compile the tests... we'll compile all three types of test separately to maximise the chances of (at least partial) success
